function DisplayHouses() {
  return (
    <div className="houses-intro md:max-w-[1290px]">
      <div className="house">
        {" "}
        <img src="./src/assets/image/Gryffindor.png" alt="Gryffindor" />
        <p>
          {" "}
      ...
      <div className="house">
        {" "}
        <img src="./src/assets/image/Hufflepuff.png" alt="Hufflepuff" />
        <p>
          {" "}
          <span className="description">
      ...
      <div className="house">
        {" "}
        <img src="./src/assets/image/Ravenclaw.png" alt="Ravenclaw" />
        <p>
          {" "}
          <span className="description">
      ...
      <div className="house">
        {" "}
        <img src="./src/assets/image/Slytherin.png" alt="Slytherin" />
        <p>
          {" "}
          <span className="description">
